...
import Choose_localguide_button from './components/choose_localguide_button'
      ...
      <Container fluid>
        <Row className="vheight-100">
          <Routes>
            ...
            <Route path='/localguide' element={ userPower === 'localguide' ? <Choose_localguide_button/> : <Navigate replace to={'/login'}></Navigate>}></Route>
